...
local Window = Fluent:CreateWindow({
    Title = "LDQ HUB REBORN",
    SubTitle = "Version Reborn by binxgodteli",
    TabWidth = 160,
...
local Tabs = {
	...
	Misc = Window:AddTab({ Title = "Other", Icon = "list-plus" }),
    Hop = Window:AddTab({ Title = "Change Server", Icoyn = "user" }),
...
ImageButton.Image = "rbxassetid://12844034959"
...
local MiscFarm = Tabs.Main:AddSection("Other Farm")
...
if Third_Sea then
    ...
    local ToggleSailBoat = Tabs.Main:AddToggle("ToggleSailBoat", {Title = "Auto Sail Boat",Description = "", Default = false })
...
if Second_Sea then
        ...
        if Third_Sea then
    local ToggleCakeV2 = Tabs.Main:AddToggle("ToggleCakeV2", {Title = "Auto Kill Katakuri V2(Need Spawn)",Description = "", Default = false })
...
if Second_Sea then
    local ToggleSwordLengend = Tabs.Main:AddToggle("ToggleSwordLengend", {Title = "Auto Buy Lengend Sword",Description = "",Default = false })
...
local ToggleTeleport = Tabs.Player:AddToggle("ToggleTeleport", {Title = "Tween To Player", Description = "",Default = false })
...
local ToggleQuanSat = Tabs.Player:AddToggle("ToggleQuanSat", {Title = "See Player",Description = "", Default = false })
...
local ToggleFastAttack = Tabs.Player:AddToggle("ToggleFastAttack", {Title = "Hit player",Description = "", Default = false })
...
local ToggleAimBotSkill = Tabs.Player:AddToggle("ToggleAimBotSkill", {Title = "Aim Bot Skill",Description = "", Default = false })
...
local ToggleSpeedRun = Tabs.Player:AddToggle("ToggleSpeedRun", {Title = "Speed Hack",Description = "", Default = true })
...
local ToggleRandomFruit = Tabs.Fruit:AddToggle("ToggleRandomFruit", {Title = "Random Fruit",Description = "(Good Luck!)", Default = false })
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "Get Fruit Low Beli",Description = "(To buy chip raid)", Default = false })
...
local ToggleKillPlayerTrial = Tabs.Race:AddToggle("ToggleKillPlayerTrial", {Title = "Auto Kill Player In Trailer",Description = "", Default = false })
...
local ToggleRandomBone = Tabs.Shop:AddToggle("ToggleRandomBone", {Title = "Random Bones",Description = "(Good Luck!)", Default = false })
...
Tabs.Misc:AddButton({
	Title = "Open Awakening Fruit Panel",
	Description = "",
	Callback = function()
...
local ToggleRejoin = Tabs.Misc:AddToggle("ToggleRejoin", {Title = "Auto Rejoin When Crash", Description = "",Default = true })
...
if First_Sea or Second_Sea then
    local Mastery = Tabs.Hop:AddSection("Please Sea 3!!!")
end
...
local SettingFarm = Tabs.Setting:AddSection("Farming")
    ...
    local ToggleBypassTP = Tabs.Setting:AddToggle("ToggleBypassTP", {Title = "Bypass Teleport",Description = "", Default = false })
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "Hide damage",Description = "", Default = true })
...
local ToggleRemoveNotify = Tabs.Setting:AddToggle("ToggleRemoveNotify", {Title = "Delete all notifications",Description = "", Default = false })
ToggleRemoveNotify:OnChanged(function(Value)
    ...
    local ToggleWhite = Tabs.Setting:AddToggle("ToggleWhite", {Title = "White Screen",Description = "(Reduce lag)", Default = false })
